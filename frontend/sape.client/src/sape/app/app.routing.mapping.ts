...
export const SAPE_PAGES_REGISTER_EVENTS_EDIT = { routingFull: "/sape/pages/register/events/edit", routingFullRegExp: /^\/sape\/pages\/register\/events\/edit\/([0-9])+$/ , routingSimple: "events/edit" };

export const SAPE_PAGES_REGISTER_EVENTS_ACTIVITIES = { routingFull: "/sape/pages/register/events/:id/activities", routingFullRegExp: /^\/sape\/pages\/register\/events\/([0-9]+)\/activities(\/([0-9]+))?$/,  routingSimple: "events_activities" };
export const SAPE_PAGES_REGISTER_EVENTS_ENTRIES = { routingFull: "/sape/pages/register/events/entries", routingFullRegExp: /^\/sape\/pages\/register\/entries(\/([0-9]+))?$/, routingSimple: "events_entries" };
