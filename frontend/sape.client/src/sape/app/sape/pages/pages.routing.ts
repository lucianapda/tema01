import { SAPE_PAGES_HOME, SAPE_PAGES_REGISTER, SAPE_PAGES_CONFIGURATION } from './../../app.routing.mapping';
/**
...
const routes: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: SAPE_PAGES_HOME.routingSimple, pathMatch: 'full' },
